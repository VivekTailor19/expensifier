                          ...
                          children: [
                            GestureDetector(
                              onTap: () async {
                                ...
                                control.selDate.value =
                                    control.setDateFormat(selectdate!);
                              },
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  Icon(Icons.calendar_month_rounded,
                                      size: 30.sp, color: Color(0xff7A7E80)),
                                  SizedBox(
                                    width: 2.w,
                                  ),
                                  Obx(() => Text(
                      ...
                      GestureDetector(
                        onTap: () async {
                          ...
                          ExpenseModel model = ExpenseModel(
                              ...
                              status: control.titleAddScreen.value,
                              ...
                              child: Container(
                                ...
                                child: CircleAvatar(
                                  ...
                                  backgroundImage: AssetImage(
                                      "assets/images/first/transfer.png"),
